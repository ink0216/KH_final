...
SELECT s.SIGUNGU_NO , s.SIGUNGU_NAME , DONG_NO 
FROM SIGUNGU  s
...
JOIN "SIGUNGU" USING (SIGUNGU_NO)
JOIN "DOSI" USING (DOSI_NO)
WHERE SIGUNGU_NO IN (105,143,255,297,257,101,178,402,
87,93,242,241,144,83,153,94);
SELECT SIGUNGU_NAME, SIGUNGU_NO
FROM "SIGUNGU"
WHERE SIGUNGU_NAME LIKE '%제천%';
