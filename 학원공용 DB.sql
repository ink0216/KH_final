...
SELECT MAX(SIGUNGU_NO)
FROM SIGUNGU s 
WHERE SIGUNGU_NAME IN ('평택시')
	GROUP BY SIGUNGU_NAME ;
SELECT SIGUNGU_NO, SIGUNGU_NAME
FROM SIGUNGU s 
WHERE SIGUNGU_NAME LIKE '평택시';
DELETE FROM SIGUNGU s 
WHERE SIGUNGU_NO IN (147,149,151);
COMMIT;